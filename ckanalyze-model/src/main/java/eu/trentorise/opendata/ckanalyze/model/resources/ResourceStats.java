...
public class ResourceStats implements Serializable {
	...
	/**
	 * 
	 * @return a list of datatype and its count. If a datatype is not present in
	 *         the resource it is not added into the list.
	 */
	 ...
	 * 
	 * @return a map with TypeName Strings as keys and frequency as values . If
	...
	/**
	 * 
	 * @return the a list of StringDistribution objects. Length with frequence 0
	 *         are omitted.
	 */
